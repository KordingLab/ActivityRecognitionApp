...
import edu.northwestern.sohrob.activityrecognition.activityrecognition.trees.BranchNode;
...
public class MatLabBinaryTreeParser extends TreeNodeParser {
    ...
    @Override
    public TreeNode parse(String content) throws TreeNode.TreeNodeException {
    ...
    private TreeNode treeForNode(int lineNo, String prefix) throws TreeNode.TreeNodeException {
